...
def cnn_model_fn(features, labels, mode, num_classes=20):
    ...
    with tf.variable_scope('vgg_16'):
        ...
        dropout1 = tf.layers.dropout(
            inputs=dense1, rate=0.5, training=mode == tf.estimator.ModeKeys.TRAIN, name='drop6')
        ...
        dropout2 = tf.layers.dropout(
            inputs=dense2, rate=0.5, training=mode == tf.estimator.ModeKeys.TRAIN, name='drop7')
        # Logits Layer
...
def main():
    ...
    pascal_classifier = tf.estimator.Estimator(
        ...
        model_dir="/tmp/pascal_model_scratch_vgg16")
